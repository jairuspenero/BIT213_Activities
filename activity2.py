# Simple Banking queue simulation program
 ...
 # Integer that describe each customer's length of transaction for each teller
 timeCustA = 1
 timeCustB = 2
 timeCustC = 3
 ...
 runTimeA = runTimeA + 1
 if runTimeA == timeItTakesA + timeCustA:
 runTimeA = 0;
 hasCustA = False
 ...
 runTimeB = runTimeB + 1
 if runTimeB == timeItTakesB + timeCustB:
 runTimeB = 0;
 hasCustB = False
 ...
 runTimeC = runTimeC + 1
 if runTimeC == timeItTakesC + timeCustC:
 runTimeC = 0;
 hasCustC = False
